...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Buat Invoice Baru</h1>
            </div>
            <div class="col-sm-6">
...
<div class="card">
    ...
    <form id="createInvoiceForm" method="POST" action="<?= base_url('invoice/store') ?>">
        <?= csrf_field() ?>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="invoiceNumber" name="invoice_number" required readonly>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="companyTo" name="company_to" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="attentionTo" name="attention_to" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="itemsTable">
                        ...
                        <tbody>
                            <tr id="row-0">
                                <td>
                                    <select class="form-control product-select select2bs4" name="items[0][product_id]" required>
                                ...
                                <td>
                                    <input type="number" class="form-control item-price" name="items[0][price]" readonly>
                                </td>
                                <td>
                                    <input type="number" class="form-control item-subtotal" name="items[0][subtotal]" readonly>
                                </td>
                                <td>
...
<script>
    $(function() {
        ...
        $('#createInvoiceForm').on('submit', function(e) {
            ...
            // Make sure all items have calculated subtotals
            $('.item-subtotal').each(function() {
                const row = $(this).closest('tr');
                updateSubtotal(row);
            });
            ...
            const hasProducts = formData.some(item => item.name.includes('[product_id]') && item.value !== '');
            if (!hasProducts) {
                e.preventDefault();
                Toast.fire({
                    icon: 'error',
                    title: 'Add at least one product to the invoice',
                });
                return false;
            }
